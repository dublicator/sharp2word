...
namespace Test.W2004
{
    public class HeadingTest : Assert
    {
        ...
        public void testFluent()
        {
            Heading1 h1 =
                (Heading1)
                Heading1.With("h111").WithStyle().Bold().Italic().Align(Align.CENTER).Create();
            Heading2 h2 =
                (Heading2)
                Heading2.With("h222").WithStyle().Bold().Italic().Align(Align.CENTER).Create();
            Heading3 h3 =
                (Heading3)
                Heading3.With("h222").WithStyle().Bold().Italic().Align(Align.CENTER).Create();
            verifyStyles(h1);
            verifyStyles(h2);
            verifyStyles(h3);
        }
